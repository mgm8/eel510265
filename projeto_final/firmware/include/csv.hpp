...
class CSV
{
    public:
         ...
         *
         * \return The required column as a list.
         */
        vmos::List<TCell> ReadColumn(unsigned int col)
        {
            if (col < this->cells[0].size())
            {
                vmos::List<TCell> column;
         ...
         *
         * \return The required row as a list.
         */
        vmos::List<TCell> ReadRow(unsigned int row)
        {
         ...
         * \return None.
         */
        void WriteColumn(unsigned int pos, vmos::List<TCell> col)
        {
         ...
         * \return None.
         */
        void WriteRow(unsigned int pos, vmos::List<TCell> row)
        {
         ...
         * \return None.
         */
        void AppendColumn(vmos::List<TCell> col)
        {
            for(unsigned int i=0; i<this->cells.size(); i++)
            {
         ...
         * \return None.
         */
        void AppendRow(vmos::List<TCell> row)
        {
    ...
    private:
        ...
        vmos::List<vmos::List<TCell> > cells;       /**< CSV table buffer. */
};
